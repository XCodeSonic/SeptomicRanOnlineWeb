        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <div className="flex items-center gap-3 ml-4 border-l border-[#ff003c]/30 pl-4">
              <a
                href="https://www.facebook.com/groups/2367796583311426"
                target="_blank"
      ...
      >
        <div className="bg-[#0d0d0d]/98 backdrop-blur-md px-6 py-4 flex flex-col gap-4">
          ...
          <div className="flex gap-4 pt-2">
            <a href="https://www.facebook.com/groups/2367796583311426" target="_blank" rel="noopener noreferrer" className="text-[#a0a0a0] hover:text-[#ff003c] transition-colors duration-300 flex items-center gap-2 font-['Orbitron'] text-xs tracking-widest">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" /></svg>
              FACEBOOK
            </a>
            <a href="https://discord.gg/ee2ZVawmVs" target="_blank" rel="noopener noreferrer" className="text-[#a0a0a0] hover:text-[#00f0ff] transition-colors duration-300 flex items-center gap-2 font-['Orbitron'] text-xs tracking-widest">
    ...
    <footer className="border-t border-[#ff003c]/20 py-10 px-6">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-6">
          <a href="https://www.facebook.com/groups/2367796583311426" target="_blank" rel="noopener noreferrer" className="text-[#555] hover:text-[#ff003c] transition-colors duration-300 font-['Orbitron'] text-xs tracking-widest">FACEBOOK</a>
          <span className="text-[#333]">|</span>
          <a href="https://discord.gg/ee2ZVawmVs" target="_blank" rel="noopener noreferrer" className="text-[#555] hover:text-[#00f0ff] transition-colors duration-300 font-['Orbitron'] text-xs tracking-widest">DISCORD</a>
        </div>
